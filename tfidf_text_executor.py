...
class TFIDFTextEncoder(Executor):
    ...
    @requests
    def encode(self, docs: Optional[DocumentArray],  *args, **kwargs):
        """
        ...
        if docs:
            document_batches_generator = self._get_input_data_generator(docs)
    ...
    def _create_embeddings(self, document_batches_generator: Iterable):
        ...
        for document_batch in document_batches_generator:
            iterable_of_texts = document_batch.get_attributes('text')
